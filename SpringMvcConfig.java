...
import com.sowjanya.spring.Employee.dao.EmployeeDAOImpl;

@Configuration
@EnableWebMvc
@ComponentScan(basePackages="com.sowjanya.Spring")
public class SpringMvcConfig implements WebMvcConfigurer {
	...
	public EmployeeDAO getEmployeeDAO() {
		EmployeeDAO dao=new EmployeeDAOImpl(getDataSource());
		return dao;
