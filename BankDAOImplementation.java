...
public class BankDAOImplementation implements BankDAO{
	...
	public BankAccount getBankAccountById(String accountId) {
		...
		return jdbcTemplate.queryForObject(SQL_FIND_ACCOUNT, new Object[] {accountId} ,new BankAccountModelMapper());
	}

	public List<BankAccount> getAllAccountHolder() {
		// TODO Auto-generated method stub
		return jdbcTemplate.query(SQL_GET_ALL, new BankAccountModelMapper());
	}
